---
name: realtime
description: Usar para todo lo de fila en vivo y sincronización en tiempo real (Supabase Realtime/WebSockets). Invocar cuando el usuario mencione "fila en vivo", "tiempo real", "sincronizar estado" o reporte parpadeo/inconsistencia entre profesional y cliente.
...
- Probar explícitamente el escenario de 50 clientes/día en una sola sede con múltiples profesionales actualizando estado simultáneamente.
